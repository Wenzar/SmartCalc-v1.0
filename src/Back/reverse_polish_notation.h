...
#define NAMES_FUNCTIONS find_unar_operators, find_empty_brackets, check_functions
...
token *get_reverse_polish_notation_array(token *token_array,int *amount_tokens);
stack_tokens *operator_is_right_bracket(token *reverse_polish_notation_array,stack_tokens *stack_operators,int *count);
stack_tokens *priority_is_less(const token token_object,token *reverse_polish_notation_array,stack_tokens *stack_operators, int *count);
void cleaning_stack_operators(token *reverse_polish_notation_array,stack_tokens *stack_operators, int *count);
